  ...
  return (
    <div className="bg-white rounded-xl shadow-sm p-6 text-center">
      {photo ? (
        ...
        <div className="w-16 h-16 bg-gold rounded-full flex items-center justify-center text-white font-bold text-lg mx-auto">
          {getInitials(name)}
        </div>
      )}
      <h3 className="font-bold text-navy mt-4">{name}</h3>
      <p className="text-sm text-gold mt-1">{role}</p>
