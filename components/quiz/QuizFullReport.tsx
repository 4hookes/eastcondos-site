  ...
  return (
    <div className="animate-fadeIn">
      ...
      <div className="text-center mb-10">
        <h2 className="text-2xl md:text-3xl font-bold text-charcoal font-serif mb-2">
          {reportContent.reportHeading}
        </h2>
        <p className="text-body">
          Your score: <span className="font-bold text-amber text-xl">{score}/100</span> — {tierLabel}
        </p>
      </div>
        ...
        {categories.map((cat) => (
          <div key={cat.label} className="bg-white rounded-xl p-6 border border-gray-100">
            <div className="flex items-center justify-between mb-3">
              <h3 className="font-bold text-charcoal">{cat.label}</h3>
              <span className="text-lg font-bold text-amber">{cat.value}%</span>
            </div>
      ...
      {/* Next Steps */}
      <div className="bg-offwhite rounded-xl p-6 md:p-8 mb-12">
        <h3 className="text-xl font-bold text-charcoal font-serif mb-4">
      ...
      {/* CTA */}
      <div className="text-center bg-charcoal rounded-xl p-8 md:p-12">
        ...
        <a href="/strategy-session" className="btn-primary text-lg">
